    ...
    */
    ...
    else if (strcmp(cmd, "mkdir") == 0)
    {
        ...
        */
        ...
        // As we said, no output here. But if you want, you can uncomment the block below,
        // that will give you a more informative command line.
        ...
        //     break;
        // case 2:
        //     cout << "Error: Directory name \"" << dirname << "\" is illegal!" << endl;
        //     break;
        // case 3:
    ...
    else if (strcmp(cmd, "rm") == 0)
    {
        ...
        */
        ...
        Dir *dir = getSubdir(wd, name);
        File *file = getSubfile(wd, name);
        ...
        {
            int code = deleteDir(wd, name, recur);
            ...
            //     break;
            // case 3:
            //     cout << "Error: Deleting a non-empty directory \"" << name << "\"!" << endl;
            //     break;
            // }
        }
        else
        {
            int code = deleteFile(wd, name);
    ...
    else if (strcmp(cmd, "mv") == 0)
    {
         ...
         * This block should not print anything to the standard output.
        */
        char tgtName[MAX_CMD_LEN] = "";
        fetch(rest, tgtName);
        char dirname[MAX_CMD_LEN] = "";
        fetch(rest, dirname);
        Dir *dir = getSubdir(wd, tgtName);
        File *file = getSubfile(wd, tgtName);
        Dir *dest = getSubdir(wd, dirname);
        if (dir == NULL && file == NULL)
        {
            // As we said, no output here. But if you want, you can uncomment the block below,
            // that will give you a more informative command line.

            // cout << "Error: \"" << tgtName << "\" not found!" << endl;
        }
        else if (dir != NULL)
        {
            int code = moveDir(dir, dest);
            ...
            //     break;
            // case 1:
            //     cout << "Error: Directory \"" << tgtName << "\" not found!" << endl;
            //     break;
            // case 2:
            //     cout << "Error: Directory \"" << dirname << "\" not found!" << endl;
            //     break;
            // case 4:
            //     cout << "Error: Name conflicts!" << endl;
            //     break;
            // case 5:
            //     cout << "Error: Cannot move a directory to itself or its descendant!" << endl;
            //     break;
            // }
        }
        else
        {
            int code = moveFile(file, dest);
            ...
            //     break;
            // case 1:
            //     cout << "Error: File \"" << tgtName << "\" not found!" << endl;
            //     break;
            // case 2:
            //     cout << "Error: Directory \"" << dirname << "\" not found!" << endl;
            //     break;
